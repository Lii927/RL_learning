...
class QLearning:
    ...
    def update(self, s0, a0, r, s1):
        # 【注意这里的区别！】
        # Q-learning 不管下一步实际执行什么动作，直接拿下一个状态的最大 Q 值来做目标
...
if __name__ == "__main__":
    ...
    gamma = 0.9
    num_episodes = 500
    agent = QLearning(ncol, nrow, epsilon, alpha, gamma) # 实例化改为 QLearning
    ...
    plt.plot(episodes_list, mv_return, color='r') # 换成红色线条以示区别
    plt.xlabel('Episodes')
    plt.ylabel('Episode Reward')
    plt.title('Q-Learning on Cliff Walking (Smoothed)')
